<?php
    ...
    try {
        $delete = mysqli_escape_string($mysqli, htmlspecialchars($_GET["idAlumno"]));
        ...
        mysqli_stmt_bind_param($stmt2, "i", $delete);
        ...
        header("Location: ../view/recepcion.php?success=Usuario eliminado con matrícula $delete");
    } catch (Exception $e) {
